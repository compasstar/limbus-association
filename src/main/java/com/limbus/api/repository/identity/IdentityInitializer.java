...
public class IdentityInitializer implements ApplicationRunner {

    private final IdentityRepository identityRepository;
    private final OffenseSkillRepository offenseSkillRepository;
    private final DefenseSkillRepository defenseSkillRepository;
    private final PassiveSkillRepository passiveSkillRepository;
    private final SkillEffectRepository skillEffectRepository;
    private final OnHitEffectRepository onHitEffectRepository;
